...
def GLONASSEphemeris(ephemerides, time_epochs):
    """
...
#     """
#     Add leap seconds based on date.
#     Input is a tupleo of week and tow (week,tow)
#     """
#     if time <= from_datetime(datetime.datetime(2006, 1, 1)):
#         raise ValueError("Have no history on leap seconds before 2006")
#     elif time <= from_datetime(datetime.datetime(2009, 1, 1)):
#         return 14
#     elif time <= from_datetime(datetime.datetime(2012, 7, 1)):
#         return 15
#     elif time <= from_datetime(datetime.datetime(2015, 7, 1)):
#         return 16
#     elif time <= from_datetime(datetime.datetime(2017, 1, 1)):
#         return 17
#     else:
#         return 18
...
#   week, tow = datetime_to_tow(datetime_)
#   return week, tow
