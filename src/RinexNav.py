...
class RinexNav:
    ...
    def filter_data_rinex_nav(self, filename, desired_GNSS, data_rate = 30):
        ...
        desired_lines = self.filter_ephemeris_data_on_time(desired_lines, time_difference_minutes=data_rate) # remove epoch with time difference less that spesificed  time
        f.close()
