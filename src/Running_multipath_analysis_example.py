...
os.chdir(os.path.join(base_path,"Multipath_analysis"))
## Path to TestData
path_to_testdata = os.path.join(base_path,'TestData')
ouputdir = os.path.join(base_path, 'Results') 

## Rinex observation file
rinObsFilename1 = path_to_testdata  + '/ObservationFiles/' + 'OPEC00NOR_S_20220010000_01D_30S_MO_3.04.rnx'
rinObsFilename2 = path_to_testdata  + '/ObservationFiles/' + 'NMBUS_SAMSUNG_S20.20o'

## SP3 files
sp3NavFilename_1      = path_to_testdata  + '/SP3/' + 'NMBUS_2020 10 30.SP3'
sp3NavFilename_1_opec = path_to_testdata  + '/SP3/' + 'Testfile_20220101.eph'


## Broadcast ephemerides
broadcastNav1 =  path_to_testdata  + '/NavigationFiles/' + 'OPEC00NOR_S_20220010000_01D_GN.rnx'
broadcastNav2 =  path_to_testdata  + '/NavigationFiles/' + 'OPEC00NOR_S_20220010000_01D_RN.rnx'
broadcastNav3 =  path_to_testdata  + '/NavigationFiles/' + 'BCEmerge_30_10_2020.20p'
broadcastNav4 =  path_to_testdata  + '/NavigationFiles/' + 'BRDC00IGS_R_20220010000_01D_MN.rnx'
