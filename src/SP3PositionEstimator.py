"""
TODO: Fiks tidsstemplene. Når blir nok feilene store siden det opereres kun med hele secunder i dataframene. 
Enten bruk TOW eller introduser bruk av mikrosekunder. 
"""
...
class SP3PositionEstimator:
    ...
    def __init__(
        ...
        # Load SP3 data
        sp3_reader = SP3Reader(sp3_file, coords_in_meter=True, desiredGNSSsystems=[desired_system])
